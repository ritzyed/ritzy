...
* Paste of clipboard data, including conversion to rich text if data is HTML.
...
* Performance improvements. Performance is already decent but much more can be
done to improve it. Some ideas:

...
// http://localhost:5000/sapi/Text%2310 to return a Text replica
// http://localhost:5000/sapi/CursorSet%23all to return a set of Cursors (TODO change all to match the text replica id)
// http://localhost:5000/sapi/Cursor%23A0017r to return the state of Cursor for user id A0017r
